...
func (c *organizationServiceClient) AcceptInvite(ctx context.Context, in *AcceptInviteRequest, opts ...grpc.CallOption) (*AcceptInviteResponse, error) {
	...
	err := c.cc.Invoke(ctx, OrganizationService_AcceptInvite_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *organizationServiceClient) ListOrgInvites(ctx context.Context, in *ListOrgInvitesRequest, opts ...grpc.CallOption) (*ListOrgInvitesResponse, error) {
	...
	err := c.cc.Invoke(ctx, OrganizationService_ListOrgInvites_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *organizationServiceClient) DeleteInvite(ctx context.Context, in *DeleteInviteRequest, opts ...grpc.CallOption) (*DeleteInviteResponse, error) {
	...
	err := c.cc.Invoke(ctx, OrganizationService_DeleteInvite_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *organizationServiceClient) SwitchOrganization(ctx context.Context, in *SwitchOrganizationRequest, opts ...grpc.CallOption) (*SwitchOrganizationResponse, error) {
	...
	err := c.cc.Invoke(ctx, OrganizationService_SwitchOrganization_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
